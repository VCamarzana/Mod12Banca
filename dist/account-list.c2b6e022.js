...
},{"./get-account-list.api":"common/api/get-account-list.api.js","./get-account.api":"common/api/get-account.api.js"}],"core/router/routes.js":[function(require,module,exports) {
"use strict";
...
var _accountList = require("./account-list.helpers");
var _accountList2 = require("./account-list.mappers");
var _helpers = require("../../common/helpers");
var _router = require("../../core/router");
(0, _api.getAccountList)().then(function (accountList) {
  var vmAccountList = (0, _accountList2.mapAccountListFromApiToVM)(accountList);
  (0, _accountList.addAccountRows)(vmAccountList);
