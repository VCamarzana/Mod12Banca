...
// export const addDataRows = data => {
//   const aliasCell = document.getElementById('alias');
//   aliasCell.textContent = data.alias;

//   const ibanCell = document.getElementById('iban');
//   ibanCell.textContent = data.iban;
...
exports.mapMovementsListFromApiToVM = exports.mapDataFromApiToVM = void 0;
...
var mapDataFromApiToVM = function mapDataFromApiToVM(data) {
  return {
    alias: data.name,
    iban: data.iban,
    balance: "".concat(data.balance, " \u20AC")
  };
};
exports.mapDataFromApiToVM = mapDataFromApiToVM;
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"common/api/get-account-list.api.js":[function(require,module,exports) {
"use strict";
...
},{"./get-account-list.api":"common/api/get-account-list.api.js","./get-account.api":"common/api/get-account.api.js"}],"common/helpers/element.helpers.js":[function(require,module,exports) {
"use strict";
...
var isSameAccount = Boolean(params.id);
if (isSameAccount) {
  (0, _movements2.getMovements)(params.id).then(function (movementsList) {
    var vmMovementsList = (0, _movements3.mapMovementsListFromApiToVM)(movementsList);
    (0, _movements.addMovementRows)(vmMovementsList);
  });
  (0, _api.getAccount)(params.id).then(function (data) {
    var vmData = (0, _movements3.mapDataFromApiToVM)(data);
    (0, _element.onSetValues)(vmData);
  });
} else {
  (0, _movements2.getMovements)().then(function (movementsList) {
    var vmMovementsList = (0, _movements3.mapMovementsListFromApiToVM)(movementsList);
    (0, _movements.addMovementRows)(vmMovementsList);
  });
  var elements = document.querySelectorAll('#alias, #iban, #balance');
  elements.forEach(function (element) {
    return element.textContent = "--";
  });
}
},{"./movements.helpers":"pages/movements/movements.helpers.js","./movements.api":"pages/movements/movements.api.js","./movements.mappers":"pages/movements/movements.mappers.js","../../core/router":"core/router/index.js","../../common/api":"common/api/index.js","../../common/helpers/element.helpers":"common/helpers/element.helpers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
