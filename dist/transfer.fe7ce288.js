...
var dayValidator = function dayValidator(_ref) {
  ...
  var succeeded = parseValue >= 1 && parseValue <= 31;
  return {
    succeeded: succeeded,
...
var monthValidator = function monthValidator(_ref2) {
  ...
  var parseValue = parseInt(value);
  var succeeded = parseValue >= 1 && parseValue <= 12;
  return {
    succeeded: succeeded,
...
var yearValidator = function yearValidator(_ref3) {
  ...
  var succeeded = parseValue >= currentYear;
  return {
    succeeded: succeeded,
    message: succeeded ? "" : "Debe escribir el año actual o superior. "
  };
};
var transactionValidator = function transactionValidator(_ref4) {
  var value = _ref4.value;
  var currentDate = new Date();
  var selectedDate = new Date(value);
  var succeeded = selectedDate > currentDate;
  return {
    succeeded: succeeded,
...
var dateValidator = function dateValidator() {
  ...
  var transaction = "".concat(year, "/").concat(month, "/").concat(day);
  var dayResult = dayValidator({
    value: day
  });
  var monthResult = monthValidator({
    value: month
  });
  var yearResult = yearValidator({
    value: year
  });
  var transactionResult = transactionValidator({
    value: transaction
  });
  var messageResult = dayResult.message + monthResult.message + yearResult.message + transactionResult.message;
  return {
...
var mapTransferFromVMToApi = function mapTransferFromVMToApi(transfer) {
  return {
    ...
    transaction: "".concat(transfer.day, "/").concat(transfer.month, "/").concat(transfer.year),
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"common/api/get-account-list.api.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../node_modules/axios/index.js"}],"common/api/get-account.api.js":[function(require,module,exports) {
"use strict";
...
var _getAccountList = require("./get-account-list.api");
Object.keys(_getAccountList).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _getAccountList[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _getAccountList[key];
    }
  });
});
var _getAccount = require("./get-account.api");
Object.keys(_getAccount).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _getAccount[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _getAccount[key];
    }
  });
});
},{"./get-account-list.api":"common/api/get-account-list.api.js","./get-account.api":"common/api/get-account.api.js"}],"pages/transfer/transfer.api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.insertTransfer = exports.getTransfer = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var getTransfer = function getTransfer(id) {
  return _axios.default.get("".concat(url, "/").concat(id)).then(function (response) {
    return response.data;
  });
};
...
var isParams = Boolean(params.id);
var transfer = {
  id: "",
  selectAccount: "",
  iban: "",
...
if (isParams) {
  (0, _api.getAccountList)().then(function (transfer) {
    return (0, _transfer.setAccountOptions)(transfer, params.id);
  });
  ...
  (0, _api.getAccountList)().then(function (transfer) {
    return (0, _transfer.setAccountOptions)(transfer, 1);
  });
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    selectAccount: 1
  });
...
(0, _helpers.onUpdateField)("select-account", function (event) {
  ...
  _transfer2.formValidation.validateField("select-account", transfer.selectAccount).then(function (result) {
...
var onSave = function onSave() {
  var apiTransfer = (0, _transfer3.mapTransferFromVMToApi)(transfer);
...
},{"../../common/helpers":"common/helpers/index.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","./transfer.validations":"pages/transfer/transfer.validations.js","../../core/router":"core/router/index.js","./transfer.mappers":"pages/transfer/transfer.mappers.js","../../common/api":"common/api/index.js","./transfer.api":"pages/transfer/transfer.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
